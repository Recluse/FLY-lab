...
def runs():
    out = {}
    for path in sorted((ROOT / "results").glob("music-v1-*/summary.json")):
...
def main():
    ...
    (ROOT / "results" / "music-v1-summary.json").write_text(json.dumps(out, indent=1))
    print("\nsaved results/music-v1-summary.json")
